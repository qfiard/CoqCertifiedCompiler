...
\usepackage{bbm}
\usepackage{ifthen}
\usepackage[paper=a4paper,hmargin=28mm,top=8mm,bottom=40mm,includehead=true,twoside=true,headsep=5mm,driver=xetex,twoside=true,bindingoffset=6mm]{geometry}
