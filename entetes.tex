...
\str{0.9}
\begin{tabular}{@{}l@{}}
{\bf \fontspec{Gill Sans Light} INF551 - Raisonnement assisté par ordinateur}\\
{\bf \fontspec{Gill Sans Light} Rapport de projet - Compilateur vérifié en Coq}
\end{tabular}\\\vspace*{3.1mm}
\str{0.9}\begin{tabular}{@{}l@{}}
{\fontsize{10pt}{12pt}\selectfont \fontspec{Gill Sans Light} Dorian Nogneng}\\{\fontsize{10pt}{12pt}\selectfont \fontspec{Gill Sans Light}  Quentin Fiard}
\end{tabular}
